                                ...
                                <div class="contact-info-wrapper">
                                    <div class="d-flex flex-wrap justify-content-between w-100">
                                        <div class="contact-info">
                                            <div class="contact-info__icon"><img src="{{asset('/')}}front/assets/images/icon/contact/1.png" alt="image"></div>
                                        ...
                                        <div class="contact-info">
                                            <div class="contact-info__icon"><img src="{{asset('/')}}front/assets/images/icon/contact/2.png" alt="image"></div>
                                            <div class="contact-info__content">
                                                <p>Email</p>
                                                <span><a href="https://pixner.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bbd2d5ddd4fbc9d2ddda95d8d4d6">[email&#160;protected]</a></span>
                                            </div>
                                        </div><!-- contact-info end -->
                                    </div>
                                    <div class="contact-thumb"><img src="{{asset('/')}}front/assets/images/elements/contact.png" alt="image"></div>
                                </div>
                            </div>
                        </div>
                    </div>
