    ...
    <div class="leftside-menu">
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarOrders" aria-expanded="false" aria-controls="sidebarEmail"
                       class="side-nav-link">
                    ...
                    <div class="collapse" id="sidebarOrders">
                        <ul class="side-nav-second-level">
                            ...
                            <li>
                                <a href="{{route('order.approved')}}">Approved Orders</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarContest" aria-expanded="false" aria-controls="sidebarEmail"
                       class="side-nav-link">
                        <i class="uil-dollar-sign"></i>
                        <span> Contest Module </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarContest">
                        <ul class="side-nav-second-level">
                            <li>
                ...
                <li class="side-nav-item">
                    <a href="{{route('ticket.manage')}}" class="side-nav-link">
                        <i class="uil-ticket"></i>
                        <span> Ticket Manage </span>
                    </a>
                </li>
                <li class="side-nav-item">
                    <a href="{{route('ticket.draw')}}" class="side-nav-link">
                        <i class="uil-ticket"></i>
                        <span> Ticket Draw </span>
                    </a>
                </li>
            </ul>
            <!--- End Sidemenu -->
