...
{{--                                </div>--}}
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail66" class="col-2 col-form-label">Icon</label>
                                    <div class="col-10">
                                        <input type="file" class="form-control @error('image') is-invalid @enderror" name="image" id="inputEmail66"/>
                                        <img src="{{asset($category->image)}}" style="height: 100px; margin-top: 1%" alt="{{$category->category_name}}">
                                        @error('image')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
